...
#ifndef KRESTIKINOLIKI_SWIFT_H
#define KRESTIKINOLIKI_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="KrestikiNoliki",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC14KrestikiNoliki11AppDelegate")
...
SWIFT_CLASS("_TtC14KrestikiNoliki22GameCollectionViewCell")
...
SWIFT_CLASS("_TtC14KrestikiNoliki18GameViewController")
...
@interface GameViewController (SWIFT_EXTENSION(KrestikiNoliki)) <UICollectionViewDataSource>
...
@interface GameViewController (SWIFT_EXTENSION(KrestikiNoliki)) <UICollectionViewDelegateFlowLayout>
- (void)collectionView:(UICollectionView * _Nonnull)collectionView didSelectItemAtIndexPath:(NSIndexPath * _Nonnull)indexPath;
- (CGSize)collectionView:(UICollectionView * _Nonnull)collectionView layout:(UICollectionViewLayout * _Nonnull)collectionViewLayout sizeForItemAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
@end


SWIFT_CLASS("_TtC14KrestikiNoliki22MainMenuViewController")
...
SWIFT_CLASS("_TtC14KrestikiNoliki10PlayerCard")
...
SWIFT_CLASS("_TtC14KrestikiNoliki13SceneDelegate")
